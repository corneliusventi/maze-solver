...
class Tests(unittest.TestCase):
    ...
    def test_maze_create_bigs_cells(self):
        num_cols = 20
        num_rows = 20
    ...
    def test_maze_break_entrance_and_exit_cells(self):
        num_cols = 12
        num_rows = 10
        m1 = Maze(0, 0, num_rows, num_cols, 10, 10, None)
        self.assertEqual(
    ...
    def test_maze_break_entrance_and_exit_small_cells(self):
        num_cols = 5
        num_rows = 5
        m1 = Maze(0, 0, num_rows, num_cols, 5, 5)
        self.assertEqual(
    ...
    def test_maze_break_entrance_and_exit_big_cells(self):
        num_cols = 20
        num_rows = 20
        m1 = Maze(0, 0, num_rows, num_cols, 20, 20)
        self.assertEqual(
